...
- *We chose to keep the word "major" in L26 to maintain consistency with the authors' original wording, but we have included quotations to denote this.*

- *In L142 (Now L145) We now say that "ex situ parameters can result in erroneous weight estimates"*

- *Ass suggested, we have changed "major" from L175 to "key" (now L201).*
...
*The text now correctly states the research was performed in the Bahamas (L38).*
