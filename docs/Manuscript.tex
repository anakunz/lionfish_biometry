...
found significant regional differences in allometric growth parameters.
The spatial pattern we observed is consistent with findings from other
studies focusing on genetics or length-at-age. We show that the use of
...
reduces this error. These findings can have substantial implications for
