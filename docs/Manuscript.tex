...
consistent with findings from other studies focused on genetics or
...
but using parameters from nearby regions substantially reduces this
error. These findings can have implications for management in terms of
