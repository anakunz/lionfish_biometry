...
<!-- Careful: the e-06 is being printed for the a value in the manuscript -->
...
<!-- Looks good.  There's one more thing that's really important for us to clarify - do we only make projections for lionfish up to 310 mm in size?  Like, the threefold over/underestimation isn't for a hypothetical lionfish that's 500 mm TL or something, right?  If so, we should tack on a sentence saying "we were conservative in our estimates in that we only used parameter pairs from other studies to estimate weights for lionfish up to 310mm in the Central Mexican Caribbean".  Or something like that.  Lmk if that makes sense. -->
